...
var DeassignResourceHistoryItem = (function (_super) {
    ...
    DeassignResourceHistoryItem.prototype.undo = function () {
        this.assignmentId = this.modelManipulator.resource.assign(this.assignment.resourceId, this.assignment.taskId).internalId;
    };
...
var ViewVisualModel = (function () {
    ...
    ViewVisualModel.prototype.findItem = function (taskId) {
        return this._itemList.filter(function (value) { return value.task && value.task.internalId === taskId; })[0];
    };
